        ...
        viewModelScope.launch {
            ...
            try {
                ...
                val result: JsonObject? = if (savedResp.isSuccessful && savedResp.body() != null) {
                    // Saved kundali: {"found": true, "kundali": {"kundali_json": "<json string>"}}
                    // Parse the nested kundali_json string to get the actual kundali data
                ...
                val finalResult = result ?: run {
                    // Fallback: calculate kundali fresh
